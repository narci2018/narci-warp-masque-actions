...
var commands = []command{
	...
	{
		name:  "web",
		brief: "run the WARPSCOUT WebUI dashboard and API server",
		intro: []string{
			"Starts an embedded web server hosting the modern WebUI dashboard and API.",
			"Default WebUI: http://0.0.0.0:29880",
			"Default SOCKS5: 0.0.0.0:29881",
			"Supports full scan control, live progress streaming, account management,",
			"one-click SOCKS5 proxy serving, and config exports.",
		},
		groups: []flagGroup{webGroup},
		setup:  setupWebFlags,
		run:    runWebCmd,
	},
	{
		name:  "pages",
		brief: "scan and generate static dashboard for Cloudflare Pages",
		intro: []string{
			"Runs a headless scan across WARP endpoints, records latency and",
			"country/colo data, and outputs a complete static site with results.json,",
			"clash-sub.yaml, wireguard.conf, endpoints.txt, and a modern web dashboard",
			"into -out-dir (default: public).",
		},
		groups: []flagGroup{pagesGroup, scanGroup, protoGroup, awgGroup, outputGroup},
		setup:  setupPagesFlags,
		run:    runPagesCmd,
	},
	{
		name:  "version",
